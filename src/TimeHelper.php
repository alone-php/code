...
class TimeHelper {
    //常见的特殊日期格式
    private static array $date_formats = [
        'Y-m-d',
        'm/d/Y',
        'd.m.Y',
        'm.d.y',
    ...
    //常见的特殊时间格式
    private static array $time_formats = ['H', 'H:i', 'H:i:s', 'H点', 'H点i分', 'H点i分s秒', 'H时', 'H时i分', 'H时i分s秒', 'g:i a', 'h:i a'];
     ...
     * @param null   $datetime 任意格式时间字符串或时间戳(默认为当前时间)
     ...
     * @return int 时间戳
     */
    public static function modifyTimestamp(string $modifier, int|string|null $datetime = null): int {
        $date = new DateTime();
     ...
     */
    public static function toFriendly(int|string $datetime, string $lang = 'zh'): string {
    ...
    /**
     * 判断日期是否为今天
     * @param int|string|null $datetime 时间日期
     * @return bool 如果是今天则返回True,否则返回False
     */
    public static function isToday(int|string|null $datetime): bool {
     ...
     */
    public static function isYesterday(int|string|null $datetime): bool {
     ...
     */
    public static function isTomorrow(int|string|null $datetime): bool {
        return self::format('Y-m-d', $datetime) == self::format('Y-m-d', strtotime('+1 day'));
    }
     ...
     */
    public static function isThisWeek(int|string|null $datetime): bool {
     ...
     */
    public static function isThisMonth(int|string|null $datetime): bool {
     ...
     */
    public static function isThisYear(int|string|null $datetime): bool {
     ...
     * @param int|string|null $datetime     要计算的时间
     * @param int|string|null $new_datetime 要比较的时间(默认为当前时间)
     * @return int 相差天数
     */
    public static function diffDays(int|string|null $datetime, int|string|null $new_datetime = null): int {
     ...
     * @return int 相差星期数
     */
    public static function diffWeeks(int|string|null $datetime, int|string|null $new_datetime = null): int {
     ...
     * @return int 相差月数
     */
    public static function diffMonths(int|string|null $datetime, int|string|null $new_datetime = null): int {
     ...
     * @return int 相差年数
     */
    public static function diffYears(int|string|null $datetime, int|string|null $new_datetime = null): int {
     ...
     * @return int 当前年份
     */
    public static function getYear(int|string|null $datetime = null): int {
     ...
     * @return int 当前季度
     */
    public static function getQuarter(int|string|null $datetime = null): int {
     ...
     * @return int 当前月份
     */
    public static function getMonth(int|string|null $datetime = null): int {
     ...
     * @return int 当前周数
     */
    public static function getWeek(int|string|null $datetime = null): int {
     ...
     * @return int 当前天数
     */
    public static function getDay(int|string|null $datetime = null): int {
     ...
     * @return int 当前小时数
     */
    public static function getHour(int|string|null $datetime = null): int {
     ...
     * @return int 当前分钟数
     */
    public static function getMinute(int|string|null $datetime = null): int {
     ...
     * @return int 当前秒数
     */
    public static function getSecond(int|string|null $datetime = null): int {
